...
export function base64ToBytes(base64: Base64Input): BytesInput {
...
export function bytesToBase62(bytes: BytesInput): string {
...
export function base64ToBase62(base64: Base64Input): string {
